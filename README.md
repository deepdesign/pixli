...
- **Motion Lab** – Density-driven layering paired with ten motion envelopes (drift, pulse, ripple, zigzag, cascade, spiral, comet, linear, isometric, triangular) and a master speed dial, now normalised so every mode feels punchy at the same slider value.
